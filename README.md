**Here is Claude.ai summary with prompts from [Go Time's podcast episode 180](https://github.com/thechangelog/transcripts/blob/master/gotime/go-time-180.md) featuring Encore.dev**
...
Here's a summary of some key questions and André's responses:
